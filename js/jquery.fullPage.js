    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + ' u-desaparecer"></div><div class="' + SLIDES_ARROW_NEXT + ' u-desaparecer"></div>');
        ...
        */
        function addSlidesNavigation(section, numSlides){
            section.append('<div class="' + SLIDES_NAV + ' u-desaparecer"><ul></ul></div>');
            ...
            for(var i=0; i< numSlides-1; i++){
                nav.find('ul').append('<li><a href="#"><span></span></a> <span class="Home-LineaNavSlider u-inline-block"></span></li>');
            }
